...
public class CreateAccountTest {
    ...
    public void testMethod(){
        ...
        RequestAccount requestBody = new RequestAccount("LaszloAutomation", "LaszloAutomation92.!");
        ...
        WebElement loghinElement = driver.findElement(By.id("login"));
        loghinElement.click();
        ...
        Assert.assertEquals(actualUserName, requestBody.getUserName(), "The username is not logged in with success.");
